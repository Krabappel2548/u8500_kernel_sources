 ...
 * @batt_res_offset		delta offset for internal battery resistance
...
#else
static int ab8500_fg_inst_curr_done(struct ab8500_fg *di)
{
}
static int ab8500_fg_get_inst_curr(struct ab8500_fg *di)
{
}
