...
/* usb-ab5500 */
static struct ab5500_platform_usb_data ab5500_usb_data  = {
	.usb_cs	=	76,
};
...
static struct ab5500_platform_data ab5500_plf_data = {
	...
	.dev_data[AB5500_DEVID_USB] = &ab5500_usb_data,
	.dev_data_sz[AB5500_DEVID_USB] = sizeof(ab5500_usb_data),
...
static struct resource cable_detect_resources[] = {
	[0] = {
		.start	= U5500_CDETECT_BASE,
		.end	= U5500_CDETECT_BASE + SZ_4K - 1,
		.flags	= IORESOURCE_MEM,
	},
	[1] = {
		.start	= IRQ_PRCMU_CD_IRQ,
		.end	= IRQ_PRCMU_CD_IRQ,
		.flags	= IORESOURCE_IRQ,
	},
};
...
static struct cable_dt_irqs cd_irq = { .base = IRQ_CD_BASE, .count = CD_NR_IRQS };

static struct platform_device cable_detect_device = {
	.name = "cable_detect",
	.id = 0,
	.num_resources = ARRAY_SIZE(cable_detect_resources),
	.resource = cable_detect_resources,
	.dev = {
		.platform_data = &cd_irq,
	},
};
