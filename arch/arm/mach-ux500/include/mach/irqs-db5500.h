...
#define IRQ_PRCMU_CD_IRQ (IRQ_PRCMU_BASE + 3)
#define IRQ_PRCMU_SRP_TIM (IRQ_PRCMU_BASE + 4)
#define IRQ_PRCMU_APE_REQ (IRQ_PRCMU_BASE + 5)
#define IRQ_PRCMU_USB (IRQ_PRCMU_BASE + 6)
#define IRQ_PRCMU_ABB (IRQ_PRCMU_BASE + 7)
#define IRQ_PRCMU_ARM (IRQ_PRCMU_BASE + 8)
#define IRQ_PRCMU_MODEM_SW_RESET_REQ (IRQ_PRCMU_BASE + 9)
#define IRQ_PRCMU_AC_WAKE_ACK (IRQ_PRCMU_BASE + 10)
...
#define IRQ_PRCMU_AC_REL_ACK (IRQ_PRCMU_BASE + 19)
#define IRQ_PRCMU_LOW_POWER_AUDIO (IRQ_PRCMU_BASE + 20)
#define IRQ_PRCMU_TEMP_SENSOR_LOW (IRQ_PRCMU_BASE + 21)
#define IRQ_PRCMU_TEMP_SENSOR_HIGH (IRQ_PRCMU_BASE + 22)
#define IRQ_PRCMU_END (IRQ_PRCMU_BASE + 23)

#define NUM_PRCMU_WAKEUPS (IRQ_PRCMU_END - IRQ_PRCMU_BASE)

/* List of virtual interrupts for Cable Detect */
#define IRQ_CD_ATTACH_UART0	IRQ_CD_BASE
#define IRQ_CD_ATTACH_UART1	(IRQ_CD_BASE + 1)
#define IRQ_CD_ATTACH_UART2	(IRQ_CD_BASE + 2)
#define IRQ_CD_ATTACH_UART3	(IRQ_CD_BASE + 3)
#define IRQ_CD_ATTACH_UART4	(IRQ_CD_BASE + 4)

#define IRQ_CD_DETACH_UART0	(IRQ_CD_BASE + 5)
#define IRQ_CD_DETACH_UART1	(IRQ_CD_BASE + 6)
#define IRQ_CD_DETACH_UART2	(IRQ_CD_BASE + 7)
#define IRQ_CD_DETACH_UART3	(IRQ_CD_BASE + 8)
#define IRQ_CD_DETACH_UART4	(IRQ_CD_BASE + 9)

#define IRQ_CD_LONG_BREAK_UART0	(IRQ_CD_BASE + 10)
#define IRQ_CD_LONG_BREAK_UART1	(IRQ_CD_BASE + 11)
#define IRQ_CD_LONG_BREAK_UART2	(IRQ_CD_BASE + 12)
#define IRQ_CD_LONG_BREAK_UART3	(IRQ_CD_BASE + 13)
#define IRQ_CD_LONG_BREAK_UART4	(IRQ_CD_BASE + 14)
