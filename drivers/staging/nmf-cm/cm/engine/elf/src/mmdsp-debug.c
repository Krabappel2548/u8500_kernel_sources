        ...
        void *componentHandle)
{
    ...
    /* to prevent memory corruption coreId index must be checked */
    if(coreId >= NB_CORE_IDS)
    {
        WARNING("cm_DSPABI_AddLoadMap error:CM_INVALID_PARAMETER, domainId:%d, coreId:%d, nb_core_IDS:%d\n",domainId,coreId,NB_CORE_IDS,0,0,0);
