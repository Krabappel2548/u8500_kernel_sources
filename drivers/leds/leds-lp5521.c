...
static DEVICE_ATTR(color, S_IRUGO | S_IWUSR, show_color, store_color);
static DEVICE_ATTR(load, S_IWUSR, NULL, store_load);
static DEVICE_ATTR(mode, S_IRUGO | S_IWUSR, show_mode, store_mode);
static DEVICE_ATTR(active_channels, S_IRUGO | S_IWUSR,
