 ...
 *
 * Sony Ericsson Renesas 61408 driver for samsung panel
 *
 * Author: Pan Yantao <yantao2.pan@sonyericsson.com>
 *
...
static const u32 ddb_rev04251A01[] = {
	0x011A2504,
	0x0000FF00,
	DDB_END
};

static const u32 ddb_mask_rev04251A01[] = {
	0xFFFFFFFF,
	0x0000FF00,
	DDB_END
};
...
const struct panel r61408_dsi_samsung_rev04251A01 = {
	.name = "Samsung LMS347TF01 MIPI/DSI rev04251A01",
	.ddb = ddb_rev04251A01,
	.ddb_mask = ddb_mask_rev04251A01,
	.id_regs = id_regs,
	...
	.height = 77,
	/* Temporary workaround for problem with chopped up image transfer */
	/* Do not enable when using more than one extra overlay (ie hdmi) */
	/* TODO: Remove when problem is solved */
